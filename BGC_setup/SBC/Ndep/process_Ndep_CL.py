...
# Load Dataset
fdir = '/work/n01/n01/dapa/SANH/RAW_DATA/SBC/SANH-Ndep/CLLOW/'
...
for year,idx in ds.groupby('time.year').groups.items():
    ofile=f'/work/n01/n01/dapa/SANH/INPUTS/SBC/BGC/CL/Ndep_y%s.nc' %year
    ds.isel(time=idx).to_netcdf(ofile,unlimited_dims='time')
    if year == 2018:
        ofile=f'/work/n01/n01/dapa/SANH/INPUTS/SBC/BGC/CL/Ndep_y2019.nc'
